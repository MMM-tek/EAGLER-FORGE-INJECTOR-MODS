(function AddHackRecipe() {
    ModAPI.meta.title("HackCraftingRecipeMod");
    ModAPI.meta.description("Adds a crafting recipe to create hack item.");

    async function AddHackRecipe() {
    ...
    ModAPI.dedicatedServer.appendCode(AddHackRecipe);
